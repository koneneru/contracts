...
import (
	_go "github.com/koneneru/contracts/account/go"
	_go1 "github.com/koneneru/contracts/auth/go"
	_go2 "github.com/koneneru/contracts/pagination/go"
...
type RefreshResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tokens        *_go1.TokenPair        `protobuf:"bytes,1,opt,name=tokens,proto3" json:"tokens,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RefreshResponse) GetTokens() *_go1.TokenPair {
	if x != nil {
		return x.Tokens
	}
	return nil
...
// Сообщения для управлеия пользователями
...
const file_gateway_service_proto_rawDesc = "" +
	...
	"\n" +
	"CreateUser\x12\x1a.gateway.CreateUserRequest\x1a\x16.google.protobuf.Empty\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\fapi/v1/users\x12]\n" +
	...
	"\x11DeleteCurrentUser\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\"\x18\x82\xd3\xe4\x93\x02\x12*\x10/api/v1/users/meB2Z0github.com/koneneru/contracts/gateway/go;gatewayb\x06proto3"
...
var file_gateway_service_proto_depIdxs = []int32{
	...
	19, // 5: gateway.RefreshResponse.tokens:type_name -> auth.TokenPair
